//String : string is a collection of characters. In typescript we can use single quote (' '), double quotes(" ") and bachticks(` `). to define a string
...
console.log("2. Method to calculate the total number of characters available in the string");
let stringLength:number = originalString.length;
console.log(`Total number of characters in string: ${stringLength}`)
