# Playwright TDD framwork - step by step

## 1. Creating a new working directory within the workspace

* Example : playwright-tdd-framwork
* terminal-command : `cd playwright-tdd-framwork`

## 2. Install necessary dependecies based on project requirements.
